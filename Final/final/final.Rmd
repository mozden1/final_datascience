...
<!-- ============================== FOOTNOTES ============================== -->
<!-- ======================================================================= -->
[^1]: 19080409, [Github Repo](https://github.com/mozden1/final_datascience)
...
library(tidyverse)
library(readxl)
yanıt <- read_excel("C:/Users/MEHMET/Desktop/ders/R/ders/Final/data/Yeni XLSX Worksheet.xlsx")
...
yanıtc %>%
  select("Youtube", "Comments", "Infuencer", "Recommendation") %>% 
